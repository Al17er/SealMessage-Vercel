...
import {downloadAndDecrypt, getObjectExplorerLink, getObjectExplorerUrl, MoveCallConstructor} from './utils';
          ...
          <Card style={{ marginTop: '1rem' }}>
            ...
            {chatState.feed && (
                <Text size="2" mt="1">
                  ...
                  <a
                      href={getObjectExplorerUrl(chatState.feed.allowlistId)}
                      target="_blank"
